...
export function Plane(props) {
  const { nodes, materials } = useGLTF("./models/plane/plane.glb");
  return (
    <group {...props} dispose={null} scale={0.3} position={[0, -3, 0]} rotationZ={Math.PI / 2}>
...
useGLTF.preload("./models/plane/plane.glb");
